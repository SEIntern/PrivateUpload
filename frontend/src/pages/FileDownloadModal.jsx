        ...
        {(() => {
          ...
          if (["jpg","jpeg","png","gif","bmp","webp","pdf"].includes(ext)) {
            return <>
              ...
              {previewUrl && (
                ext === "pdf"
                  ? <iframe src={previewUrl} title="PDF Preview" width="100%" height="500px" className="mb-2" />
                  : <img src={previewUrl} alt="preview" className="mb-2 max-w-full object-contain mx-auto" style={{ width: '100%', height: 'auto', maxHeight: '500px' }} />
              )}
            </>;
          }
          return null;
